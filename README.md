...
| [교내] 텍스트데이터분석 | 코로나숙박업소 | 오늘의 집 포스팅 데이터 분석을 통한 코로나 이후 숙박업소 방향성 제시 | [링크](https://github.com/Chanjinee/Project/tree/main/Text%20mining) |

## Certificate
| 시험명 | 취득일 | 주관 |
| :------: | :------: | :------: |
| 제41회 SQL 개발자(SQLD) | 2021.06.25 | 데이터자격검정 |
| 제31회 데이터분석 준전문가(ADsP) | 2021.12.03 | 데이터자격검정 |
